    ...
    <div className="container-main py-10">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-brand-900">Edit Profile</h1>
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white border border-brand-200 rounded-2xl p-6 shadow-card">
            <h2 className="text-lg font-semibold text-brand-900 mb-4">Personal Information</h2>
          ...
          {/* Institution */}
          <section className="bg-white border border-brand-200 rounded-2xl p-6 shadow-card">
            <h2 className="text-lg font-semibold text-brand-900 mb-4">Institution</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="sm:col-span-2">
          ...
          {/* Research Profile */}
          <section className="bg-white border border-brand-200 rounded-2xl p-6 shadow-card">
            <h2 className="text-lg font-semibold text-brand-900 mb-4">Research Profile</h2>
          ...
          {/* Alert Preferences */}
          <section className="bg-white border border-brand-200 rounded-2xl p-6 shadow-card">
            <h2 className="text-lg font-semibold text-brand-900 mb-4">Email Alerts</h2>
